            ...
            <FAQS >
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle(!toggle)}/></span> What is PeersApp?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle1(!toggle1)}/></span> Who is PeersApp for?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle2(!toggle2)}/></span> Where can I get PeersApp?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle3(!toggle3)}/></span> How do I sign up on PeersApp?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle4(!toggle4)}/></span> How do I contact people?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle5(!toggle5)}/></span> Who can see my personal information like <br /> my email address, phone number, etc?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle6(!toggle6)}/></span>  How do I know my personal information is safe?</h5>
                    </header>
                ...
                <Article >
                    <header>
                        ...
                        <h5 ><span><GrFormAdd onMouseOver={() => setToggle7(!toggle7)}/></span> Is there anyone I can talk to incase of questions or complaints?</h5>
                    </header>
